...
def send_email(message: dict, test: bool = False) -> None:
    ...
    if not test:
        msg["Cc"] = "ssayahpo@andrew.cmu.edu, yshenjeffrey@gmail.com, dustin.nguyen16@gmail.com, Nicolezcui@gmail.com, pham0579@umn.edu, ronak@ronakpjain.com, brian.hwanhee.cho@gmail.com"
